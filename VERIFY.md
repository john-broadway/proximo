...
## 1. The tool count is real (912) — introspect it, don't read it
...
"buildSignerURI": ".github/workflows/release.yml@refs/tags/v0.42.0"
```
...
curl -s -o /dev/null -w '%{http_code}\n' \
  https://pypi.org/integrity/proximo-proxmox/0.42.0/proximo_proxmox-0.42.0-py3-none-any.whl/provenance
